...
@section("title", "الصفحات الثابتة - سلة المهملات")
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">           
                        <a class="btn btn-sm confirm btn-warning" href='{{ route("staticpage.restore", ["id" => $item->id]) }}'><i class='fa fa-redo'></i> استرجاع</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
