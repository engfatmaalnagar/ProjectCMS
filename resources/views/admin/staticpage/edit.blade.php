...
<div id="app">
    <form class="w-50" method="POST" action="{{route('staticpage.update',$item->id)}}">
        ...
        <div class="form-group notCode">
            ...
            <input value="{{ $item->image }}" type="hidden" class="form-control" id="image" name="image" placeholder="اصورة">
...
<div class="custom-control custom-checkbox">
  ...
  <label class="custom-control-label" for="customCheck1">فعالية الشريحة</label>
        ...
        <a class="btn btn-dark" href="{{ route('staticpage.index') }}">الغاء الأمر</a>		
    </form>
</div>
