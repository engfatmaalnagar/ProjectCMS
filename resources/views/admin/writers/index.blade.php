...
@section("content")
    ...
    <form class="row">
        ...
        <div class="col-sm-3">
            <a class="btn btn-success float-right mb-3" href="{{ route('writers.create') }}"><i class='fa fa-plus'></i> اضافة كاتب جديد</a>
        </div>
    </form>
    @if($items->total()>0)
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">           
                        <a class="btn btn-sm btn-primary" href='{{ route("writers.edit", ["id" => $item->id]) }}'><i class='fa fa-edit'></i> تعديل</a>
                        <a class="btn btn-sm btn-danger confirm" href='{{ route("writers.delete", $item->id) }}'><i class='fa fa-trash'></i> حذف</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
