...
<section id="inner-headline">
				...
				<div class="row">
					<div class="col-lg-12">
						<ul class="breadcrumb">
							...
							<li class="active">البومات الصور</li>
						</ul>
					</div>
				</div>
			</div>
    ...
    <form class="row">
        ...
        <div class="col-sm-2">
            <select name='order_by' class='form-control text-right'>
    ...
    @foreach($items as $photo)
					<div class="col-sm-6 article-item col-md-4" style="margin-bottom:30px;">
						<a href="{{ asset('Technophoto/' . $photo->id ) }}" class="thumbnail">
						<img class="media-object" src="{{ asset('thumb.php?size=350x230&src=storage/images/' . $photo->photos[0]->file) }}" alt="{{ $photo->name }}">
						<div class="caption">
                            <h4>{{ $photo->name }} ({{ $photo->photos->count() }})</h4>
