...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $articles = Article::where("deleted",0)->where("published",1)->orderBy('id','desc')->take(9)->get();
        return view('home',compact('sliders','articles'));
    }
    public function articles(Request $request)
    {
        ...
        return view("home.articles", compact("items","types","categories"));
    }
    ...
    public function videos(Request $request)
    {
        ...
        return view("home.videos", compact("items"));
    }
    ...
    public function photos(Request $request)
    {
        ...
        return view("home.photos", compact("items"));
    }
    public function photo($id)
    {
        ...
        return view('home.photo')->withItem($item);
    ...
    public function page($id)
    {
        ...
        return view('home.page')->withItem($item);
    }
